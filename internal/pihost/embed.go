...
// jarvis binary. pihost.mjs is a self-contained Node ESM program that loads a pi
// extension using pi's real runtime and re-exposes it over jarvis's JSON-RPC
...
// jarvis binary — there is no separate file to ship or version-skew.
package pihost
